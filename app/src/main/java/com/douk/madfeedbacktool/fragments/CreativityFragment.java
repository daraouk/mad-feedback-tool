...
public class CreativityFragment extends Fragment {
    ...
    private static String RATING_TITLE = "CREATIVITY_RATING";
    private static String COMMENTS_TITLE = "CREATIVITY_COMMENTS";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_feedback_creativity, container, false);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((FeedbackActivity) getActivity()).setCurrentItem(4, true);
            }
        });
